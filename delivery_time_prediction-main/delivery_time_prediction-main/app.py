...
data = [Delivery_person_Age, Delivery_person_Ratings, Weather_condtitions, Road_traffic_density, Vehicle_condition, Type_of_order, multiple_diliveries, Festival, City, Displacement]
